            ...
            <div className="w-full md:w-3/4 flex flex-col">
                ...
                >
                    ...
                    {messages.map((msg, idx) => (
                        <div
                            key={idx}
                            className={`flex items-end max-w-[80%] ${msg.role === 'user' ? 'ml-auto flex-row-reverse' : 'mr-auto'
                                }`}
                        >
                            {/* Avatar */}
                            <div
                                className={`flex-shrink-0 rounded-full w-8 h-8 flex items-center justify-center font-bold select-none ${msg.role === 'user'
