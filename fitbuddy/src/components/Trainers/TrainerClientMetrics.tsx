...
export default function AcceptedClientsMetrics() {
    ...
    const fetchClientsMetrics = async () => {
        ...
        setError(null);
        try {
            const res = await axios.get<AcceptedClient[]>('http://localhost:3000/trainer-requests/accepted-clients-metrics', {
    ...
    return (
        <div className="p-6 bg-white rounded-xl shadow w-full">
            <h2 className="text-xl font-bold mb-4 text-black">Your Clients Metrics</h2>
                ...
                <div className="space-y-6">
                    {paginatedClients.map(client => {
                        ...
                        return (
                            <div
                                key={client.clientId}
                                className="bg-white border border-gray-300 rounded-xl p-6 shadow-sm transition hover:shadow-md"
                            >
