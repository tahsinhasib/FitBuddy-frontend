        ...
        <>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {visiblePlans.map((plan, idx) => {
              ...
              const Icon = status === 'Upcoming' ? FaClock : status === 'In Progress' ? FaHourglassHalf : FaCheckCircle;
                      ...
                      <div className="mt-4">
                        ...
                        <ul className="list-disc list-inside text-sm text-gray-800 dark:text-gray-200 space-y-1">
                          {plan.exercises.map((ex: any, i: number) => (
                            <li key={`${ex.name}-${ex.sets}-${ex.reps}-${i}`} className="hover:text-blue-600 dark:hover:text-blue-400 cursor-default">
